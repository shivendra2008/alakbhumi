...
define( "RECIPIENT_NAME", "Alakbhumi Agroproducts and services Private Limited" );
define( "RECIPIENT_EMAIL", "info@alakbhumiagro.com" );
...
if ( $name && $senderEmail && $message ) {
  $recipient = Alakbhumi Agroproducts and services . " <" . info@alakbhumiagro.com . ">";
